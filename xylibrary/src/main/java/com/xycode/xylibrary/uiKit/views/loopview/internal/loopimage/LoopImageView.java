...
public class LoopImageView extends ImageView {
    ...
    private com.kevin.loopview.internal.loopimage.LoopImageTask currentTask;
    ...
    public void setImageUrl(String url) {
        setImage(new com.kevin.loopview.internal.loopimage.LoopImage(this, url), null, null);
    }

    public void setImageUrl(String url, final Integer loadingResource) {
        setImage(new com.kevin.loopview.internal.loopimage.LoopImage(this, url), loadingResource, null);
    }

    public void setImageUrl(String url, final Integer loadingResource, final Integer fallbackResource) {
        setImage(new com.kevin.loopview.internal.loopimage.LoopImage(this, url), loadingResource, fallbackResource);
    }

    public void setImage(final com.kevin.loopview.internal.loopimage.LoopImage image, final Integer loadingResource, final Integer fallbackResource) {
        // 设置下载的时候显示的图片
        ...
        // 创建一个新的线程
        currentTask = new com.kevin.loopview.internal.loopimage.LoopImageTask(getContext(), image); // SmartImageTask实现Runnable方法
